                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <p>
                                    ...
                                    <span>The peaceful beachfront setting and friendly staff made our stay unforgettable. The mini church
                                        was a lovely spot for quiet reflection. We can't wait to come back!</span>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <p>
                                    <i class="bi bi-quote quote-icon-left"></i>
                                    <span>The hall was perfect for our event, and the mini bar was a great place to unwind afterward. The
                                        entire experience was relaxing and enjoyable.</span>
                                    <i class="bi bi-quote quote-icon-right"></i>
                                </p>
                            </div>
                        </div><!-- End testimonial item -->
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <p>
                                    <i class="bi bi-quote quote-icon-left"></i>
                                    <span>Absolutely loved our stay! – The serene atmosphere and refreshing mini swimming pool were
                                        exactly what we needed. <?php include './system-title.php' ?> is a hidden gem!</span>
                                    <i class="bi bi-quote quote-icon-right"></i>
                                </p>
                            </div>
                        </div><!-- End testimonial item -->
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <p>
                                    <i class="bi bi-quote quote-icon-left"></i>
                                    <span>The staff went above and beyond to make our stay special. The resort’s tranquil environment was
                                        ideal for relaxation, and we enjoyed the mini bar every evening!</span>
                                    <i class="bi bi-quote quote-icon-right"></i>
                                </p>
                            </div>
                        </div><!-- End testimonial item -->
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <p>
                                    <i class="bi bi-quote quote-icon-left"></i>
                                    <span>We hosted a beautiful family event in the hall, and the accommodations were top-notch. The
                                        peaceful surroundings made for a rejuvenating vacation.</span>
                                    <i class="bi bi-quote quote-icon-right"></i>
                                </p>
                            </div>
                        </div><!-- End testimonial item -->
